...
if ( ! class_exists( 'kmgimport_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since kmgimport
	 */
	class kmgimport_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'kmgimport' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'kmgimport' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'kmgimport' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'kmgimport' ),
						'full'    => esc_html__( 'Full text', 'kmgimport' ),
					),
				)
			);
			...
			include_once get_theme_file_path( 'classes/class-kmgimport-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			// Register the custom control.
			$wp_customize->register_control_type( 'kmgimport_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new kmgimport_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'kmgimport' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
